        ...
        <div className="hidden items-center gap-2 md:flex">
          {links.map((link, i) => (
            link.href.startsWith('http') ? (
              <a key={i} className={buttonVariants({ variant: 'ghost' })} href={link.href} target="_blank" rel="noreferrer">
                {link.label}
              </a>
            ) : (
          ...
          <Link className={buttonVariants({ variant: 'outline' })} to="/#auth">
            Sign In
          </Link>
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            <Link className={buttonVariants({ variant: 'outline', className: 'w-full' })} to="/#auth">
              Sign In
            </Link>
            <Link className={buttonVariants({ variant: 'default', className: 'w-full' })} to="/#auth">
              Get Started
            </Link>
          </div>
        </div>
